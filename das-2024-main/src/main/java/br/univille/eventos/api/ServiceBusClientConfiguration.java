...
public class ServiceBusClientConfiguration {
    ...
    private static final String SUBSCRIPTION_NAME= "subsguilhermeleandro";
    private static final String QUEUE_NAME = "queue-guilhermeleandro";
    ...
    ServiceBusSenderClient serviceTopicBusSenderClient(ServiceBusClientBuilder builder) {
        return builder
               .sender()
    ...
    ServiceBusSenderClient serviceQueueBusSenderClient(ServiceBusClientBuilder builder) {
        return builder
               .sender()
